...
public class Product_test extends HttpServlet {
        ...
        try {
            ...
            if (categoryIdParam != null && !categoryIdParam.isEmpty()) {
                try {
                    ...
                    // Nếu ID không phải số (ví dụ ai đó gõ bậy), lấy tất cả sản phẩm
            ...
            // --- QUAN TRỌNG: Sửa tên file ở đây cho đúng ---
            // Lưu ý: Tên file phân biệt chữ HOA/thường
