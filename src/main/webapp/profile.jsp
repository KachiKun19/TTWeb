                ...
                <c:choose>
                    ...
                    <c:when test="${pwStep == 'verify'}">
                        <p class="text-sm text-gray-500 mb-4">
                            Chúng tôi đã gửi mã OTP đến email: <strong
                                class="text-gray-700">${sessionScope.user.email}</strong>
                        </p>
                        ...
                        <div class="mb-4 px-4 py-3 bg-red-50 border border-red-200 text-red-600 rounded-xl text-sm hidden"
                             id="cpExpiredMsg">
                            <i class="fas fa-hourglass-end"></i> Mã OTP đã hết hạn! Vui lòng nhấn <strong>Gửi lại
                            OTP</strong>.
                        </div>
                        ...
                        <form action="profile" method="POST" id="cpVerifyForm">
                            ...
                            <div class="flex gap-2 justify-center mb-4">
                                <input type="text" name="otp1"
                                       class="cp-otp w-11 h-11 text-center text-xl font-bold border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-300"
                        ...
                        <script>
                            (function () {
                                ...
                                var iv = setInterval(function () {
                                    ...
                                    if (otpRem > 0) {
                                        timerDisp.textContent = fmt(otpRem);
                                        if (otpRem <= 60) timerDisp.style.color = '#dc2626';
                                    } else markExpired();
                            ...
                            function doCpResend() {
                                document.getElementById('cpResendForm').submit();
                            }
                        </script>
                    </c:when>
                    ...
                    <c:otherwise>
                        <form action="profile" method="POST" class="space-y-4" onsubmit="return cpValidatePw()">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-600 mb-1">Mật khẩu cũ <span
                                        class="text-red-400">*</span></label>
                                <input type="password" name="oldPassword" required
                                       class="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-pink-300 transition"/>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-600 mb-1">Mật khẩu mới <span
                                        class="text-red-400">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-600 mb-1">Xác nhận mật khẩu mới <span
                                        class="text-red-400">*</span></label>
