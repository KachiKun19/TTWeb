...
<body>
	...
	<section class="hero">
		...
		<div class="hero-content">
			<p class="hero-subtitle">Phiên bản mới nhất hợp tác giữa Pulsar và
				PRX / T1</p>
			<h1 class="hero-title">Pulsar X2 Crazylight PRX /
				T1 Edition</h1>
	...
	<section class="categories">
		...
		<a href="products?category=1" class="category-card">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="-5 -10 110 135" class="category-icon">
                <path
            ...
            <span class="category-name">Chuột gaming</span>
		</a>

		<!-- Bàn phím cơ -->
		<a href="products?category=2" class="category-card">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 60" class="category-icon">
                <g data-name="Layer 4">
                    <path
            ...
            <span class="category-name">Bàn phím cơ</span>
		</a>
		...
		<a href="products?category=3" class="category-card">
            ...
            <span class="category-name">Lót chuột</span>
		</a>
		...
		<a href="products?category=4" class="category-card">
            ...
            <span class="category-name">Ghế công thái học</span>
		</a>

		<!-- Khu vực khác -->
		<a href="products?category=5" class="category-card">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125" class="category-icon">
                <path
