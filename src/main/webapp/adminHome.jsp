...
<head>
    ...
    <style>
        ...
        .bg-success-gradient {
            ...
            background-image: linear-gradient(90deg, #20c997 0%, #28a745 100%);
        }

        .bg-warning-gradient {
            background-color: #ffc107;
            background-image: linear-gradient(90deg, #ffc107 0%, #fd7e14 100%);
        }

        .bg-danger-gradient {
            background-color: #dc3545;
            background-image: linear-gradient(90deg, #ff6b6b 0%, #dc3545 100%);
        }
...
<div class="admin-container">
    ...
    <div class="main-content">
        <div class="welcome-message">
            ...
            <p>Đây là bảng điều khiển quản trị của Kachi-Kun Shop. Bạn có thể quản lý người dùng, sản phẩm, đơn hàng và
                xem thống kê từ đây.</p>
                        ...
                        <div class="summary-stats">
                            ...
                            <div class="stat-item">
                                ...
                                <span class="stat-value total-revenue">
                                            <fmt:formatNumber value="${totalYearRevenue}" type="currency"
                                                              currencySymbol="₫"/>
                                        </span>
                            </div>
                        </div>
