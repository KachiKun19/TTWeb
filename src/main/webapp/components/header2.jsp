    ...
    <div class="container">
        <div class="logo">
            <a href="home" class="flex items-center">
                <img src="images/LogoChuan.png" alt="Kachi-Kun Shop Logo"
        ...
        <div class="flex items-center space-x-8 text-white">
            ...
            <div class="relative inline-block text-left">
                ...
                <div id="user-dropdown"
                     class="hidden absolute right-0 z-50 mt-3 w-64 bg-white rounded-xl
                    ...
                    <c:choose>
                        <c:when test="${not empty sessionScope.user}">
                            <div class="px-6 py-4 bg-gray-50 border-b border-gray-100">
                                ...
                                <p class="text-base font-bold text-gray-800 truncate leading-tight">
                                        ${sessionScope.user.fullName}</p>
                                <p class="text-xs text-gray-400 truncate mt-0.5">@${sessionScope.user.email}</p>
                            </div>
                            <div class="p-2 border-b border-gray-100">
                                <a href="profile"
                                   class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-700
                                          rounded-lg hover:bg-gray-100 hover:text-pink-600 transition-colors">
                                    <i class="fas fa-user-circle w-6 text-center mr-2 text-gray-400"></i>
                                    Tài khoản của tôi
                                </a>
                                <a href="order-history"
                                   class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-700
                                          rounded-lg hover:bg-gray-100 hover:text-pink-600 transition-colors">
                                    <i class="fas fa-receipt w-6 text-center mr-2 text-gray-400"></i>
                                    Đơn mua
                                </a>
                            </div>
                            <a href="logout"
                               class="block px-6 py-3.5 text-sm text-red-500 hover:bg-red-50 hover:text-red-600
                        ...
                        <c:otherwise>
                            <div class="p-2">
                                <a href="login"
                                   class="flex items-center px-4 py-3 text-sm font-medium text-gray-700
                                          rounded-lg hover:bg-gray-100 hover:text-pink-600 transition-colors">
                                    <i class="fas fa-sign-in-alt w-6 text-center mr-2 text-gray-400"></i>
                                    Đăng nhập
                                </a>
                                <a href="login#signup"
                                   class="flex items-center px-4 py-3 text-sm font-medium text-gray-700
            ...
            <c:if test="${not empty sessionScope.user}">
                <div class="relative">
                    ...
                    <div id="notiDropdown"
                        ...
                        <div class="p-3 border-b font-bold">Thông báo</div>
                        <div class="max-h-60 overflow-y-auto">
                            <c:forEach var="item" items="${list}">
                                <div class="p-3 border-b hover:bg-gray-100 text-sm">
                                    <c:choose>
                                        <c:when test="${item.replyMessage != null}">
                                            <p class="font-semibold text-green-600">${item.replyMessage}</p>
                                        </c:when>
                                        <c:otherwise>
                                            <p class="text-yellow-500">Đang chờ phản hồi...</p>
                                        </c:otherwise>
                                    </c:choose>
            ...
            <div class="relative">
                <button id="cartDropdownButton" data-dropdown-toggle="cartDropdown"
                    ...
                    <span id="cart-badge"
                          class="absolute -top-1 -right-2 bg-pink-600 text-white text-[10px] font-bold
                                 px-1.5 py-0.5 rounded-full border-2 border-[#1a1a1a]"
                ...
                <div id="cartDropdown"
                     class="z-50 hidden bg-white divide-y divide-gray-100 rounded-xl shadow-lg w-48
                        ...
                        <li>
                            <a href="cart"
                               class="block px-4 py-3 hover:bg-pink-50 hover:text-pink-600 transition flex items-center group">
                                <span class="bg-pink-100 text-pink-600 w-8 h-8 rounded-full flex items-center
                                             justify-center mr-3 group-hover:bg-pink-200 transition">
                        ...
                        <li>
                            <a href="order-history"
                               class="block px-4 py-3 hover:bg-blue-50 hover:text-blue-600 transition flex items-center group">
                                <span class="bg-blue-100 text-blue-600 w-8 h-8 rounded-full flex items-center
                                             justify-center mr-3 group-hover:bg-blue-200 transition">
...
<div id="search-overlay" class="search-overlay">
    ...
    <div class="search-overlay-content w-full max-w-2xl mx-auto px-4">
        <input oninput="searchByName(this)"
               ...
               class="search-overlay-input w-full p-4 text-xl border-b-2
                      border-gray-300 focus:border-blue-500 outline-none bg-transparent"/>
