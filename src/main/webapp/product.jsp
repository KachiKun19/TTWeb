                        ...
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <div>
                                <button id="dropdownDefaultButton"
                                        ...
                                        type="button">
                                    <span id="sort-label">Sắp xếp: Mặc định</span> <i
                                ...
                                <div id="dropdownSort"
                                    ...
                                    <ul class="py-2 text-sm text-gray-700"
                                        ...
                                        <li><a href="#" onclick="chonSapXep('newest', 'Mới nhất')"
                                               class="block px-4 py-2 hover:bg-gray-100">Mới nhất</a></li>
                                        <li><a href="#" onclick="chonSapXep('price_asc', 'Giá thấp đến cao')"
                                               class="block px-4 py-2 hover:bg-gray-100">Giá (thấp đến cao)</a></li>
                                        <li><a href="#" onclick="chonSapXep('price_desc', 'Giá cao đến thấp')"
                                               class="block px-4 py-2 hover:bg-gray-100">Giá (cao đến thấp)</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

                        <%-- [SỬA] productGrid bao gồm cả phân trang để AJAX replace hết một lượt --%>
                        <div id="productGrid"
                             class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <%-- Nội dung ban đầu — sẽ bị replace ngay bởi filterProducts(1) khi trang load --%>
                        </div>
                    </section>
                </div>
            </div>
