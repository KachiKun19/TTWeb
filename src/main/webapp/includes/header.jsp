                    ...
                    <c:choose>
                        <c:when test="${not empty sessionScope.user}">
                            <div class="px-6 py-4 bg-gray-50 border-b border-gray-100">
                                <p class="text-xs text-gray-400 uppercase tracking-wider font-semibold mb-1">Tài
                                    khoản</p>
                            ...
                            <div class="p-2 border-b border-gray-100">
                                <a href="profile"
                                   class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 hover:text-pink-600 transition-colors">
                                    <i class="fas fa-user-circle w-6 text-center mr-2 text-gray-400"></i> Tài khoản của tôi
                                </a>
...
<div id="search-overlay" class="search-overlay">
    ...
    <div class="search-overlay-content w-full max-w-2xl mx-auto px-4">
        ...
        <div id="search-results"
             class="mt-4 max-h-[60vh] overflow-y-auto bg-white rounded-lg shadow-xl p-2 hidden"></div>
    </div>
</div>