...
<div class="container" id="container">
        ...
        <c:if test="${empty registerStep}">
            <form action="register" method="post" id="registerForm">
                ...
                <div id="password-strength"
                     style="width: 100%; height: 5px; margin-bottom: 10px; transition: all 0.3s; border-radius: 2px;"></div>
                <small id="password-msg"
                       style="color: red; display: none; margin-bottom: 10px; font-weight: bold; font-size: 12px;"></small>

                <div class="password-wrapper">
                    <input type="password" id="rePass" name="repassword" placeholder="Nhập lại mật khẩu" required/>
                    <button type="button" class="toggle-password" onclick="toggleRePassword()">
                        <i class="fas fa-eye" id="rePassIcon"></i>
                    </button>
                </div>
    ...
    <div class="form-container sign-in-container">
        <form action="login" method="post">
            ...
            <input type="text" name="username" placeholder="Tên đăng nhập" required value="${loginUsername}"/>
            <div class="password-wrapper">
            ...
            <c:if test="${showCaptcha}">
                <div style="width:100%; margin: 4px 0 0;">
                    <div style="font-size:13px; color:#555; text-align:left; margin-bottom:6px;">
                        <i class="fas fa-shield-alt" style="color:#2d7e7e;"></i>
                        Xác nhận bảo mật: <strong>${captchaQuestion}</strong>
                    </div>
                    <input type="number" name="captcha" placeholder="Nhập kết quả"
...
<script>
    ...
    function toggleRePassword() {
        const input = document.getElementById('rePass');
        const icon = document.getElementById('rePassIcon');
        if (input.type === 'password') {
            input.type = 'text';
            icon.classList.replace('fa-eye', 'fa-eye-slash');
        } else {
